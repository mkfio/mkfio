...
public:
    ...
    virtual void ListTx(const uint256& hashFork, std::vector<CTxInfo>& vTxPool, const int64 nGetOffset = 0, const int64 nGetCount = 0) = 0;
...
public:
    ...
    virtual void ListTxPool(const uint256& hashFork, std::vector<CTxInfo>& vTxPool, const int64 nGetOffset = 0, const int64 nGetCount = 0) = 0;
