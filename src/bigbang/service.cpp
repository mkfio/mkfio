...
void CService::ListTxPool(const uint256& hashFork, vector<CTxInfo>& vTxPool, const int64 nGetOffset, const int64 nGetCount)
{
    vTxPool.clear();
    pTxPool->ListTx(hashFork, vTxPool, nGetOffset, nGetCount);
}
